...
/** Public legal documents (hosted separately from the mobile app). */
export const TERMS_OF_USE_URL =
  'https://grand-marigold-123380.netlify.app/termos-de-uso';

export const PRIVACY_POLICY_URL =
  'https://grand-marigold-123380.netlify.app/politica-de-privacidade';
